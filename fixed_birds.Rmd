...
#added correct variablel name "species_id" instead of species
```
...
#added an underscore for groupby to be group_by
```
...
#replaced the last pipe operator with a plus sign. 
```
...
#changed the left_join input to the other dataset sites_1
```
...
#one of the park names was misspelled, changed to Palomino instead of Palamino
```
